            ...
            <div className="flex-1 bg-white rounded-t-[3rem] -mt-10 p-8 pb-12 shadow-[0_-20px_50px_rgba(0,0,0,0.05)] relative z-20">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            <label className="text-[10px] uppercase tracking-[0.2em] font-black text-slate-300 ml-1">Security Key</label>
                            <div className="relative border-b-2 border-slate-50 focus-within:border-emerald-500 transition-colors py-1 group">
                                <input
                        ...
                        <div className="space-y-1">
                            <label className="text-[10px] uppercase tracking-[0.2em] font-black text-slate-300 ml-1">Repeat</label>
                            <div className="relative border-b-2 border-slate-50 focus-within:border-emerald-500 transition-colors py-1 group">
                                <input
                                    type={showPassword ? 'text' : 'password'}
                ...
                <div className="mt-10 text-center">
                    <p className="text-slate-400 text-sm font-medium">
                        Already a member? <Link href="/auth/login" className="text-emerald-600 font-bold underline underline-offset-4 decoration-emerald-500/30 hover:decoration-emerald-500 transition-all">Sign in to portal</Link>
                    </p>
                </div>
            </div>
        </div>
