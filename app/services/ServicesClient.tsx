...
export default function ServicesClient({ initialServices, initialSettings, pagination }: ServicesClientProps) {
    ...
    // Services loaded from server props
    useEffect(() => {
            ...
            <main className="relative z-10">
                ...
                {pagination && pagination.totalPages > 1 && (
                    <section className="pb-16 px-4">
                        <div className="max-w-7xl mx-auto">
                            <div className="flex flex-col sm:flex-row justify-between items-center bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    <Link
                                        ...
                                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${pagination.hasPrevPage
                                        ...
                                        {Array.from({ length: Math.min(5, pagination.totalPages) }, (_, i) => {
                                            ...
                                            return (
                                                <Link
                                                    ...
                                                    className={`w-10 h-10 flex items-center justify-center rounded-lg text-sm font-medium transition-all ${pagination.currentPage === pageNum
                                    ...
                                    <Link
                                        href={`/services?page=${pagination.currentPage + 1}`}
                                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${pagination.hasNextPage
                                            ? 'bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300'
                                            : 'bg-slate-50 border border-slate-100 text-slate-400 cursor-not-allowed'
                                            }`}
